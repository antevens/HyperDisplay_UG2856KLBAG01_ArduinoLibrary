...
class UG2856KLBAG01_I2C : public SSD1309_Arduino_I2C
{ // This is a particular display from WiseChip. Get it here:
    private:
    protected:
    public:
...
class UG2856KLBAG01_SPI : public SSD1309_Arduino_SPI
{ // This is a particular display from WiseChip. Get it here:
    private:
    protected:
    public:
